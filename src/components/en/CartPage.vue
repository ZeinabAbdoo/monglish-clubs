    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <div class="header-left">
          <h1>
            Academic Acceptance Declaration for Monglish International Academy
            <br />
            "MIA-TC 01"
          </h1>
        </div>
      ...
      <div class="modal-terms">
        <h2>
          To ensure your full rights in contracting with the academy, please
          read the following terms carefully and agree to them:
        </h2>
        <div class="terms-container">
          <div class="terms-content">
            <ol>
              <li>
                <strong>Academy Policies:</strong><br />
                I pledge to adhere to all policies and procedures followed
                within the academy, and I acknowledge that I have reviewed and
                fully understood them and agreed to them.
              </li>
              <li>
                <strong>Tuition Fees:</strong><br />
                I acknowledge that I have reviewed the established tuition fees
                and I pledge to pay them on time. I understand that in case of
                delayed payment, the academy has the right to take appropriate
                actions including suspending the account or halting educational
                services until the dues are paid.
              </li>
              <li>
                <strong>Online Attendance and Discipline:</strong><br />
                I pledge to ensure that my son/daughter attends the online
                classes regularly and at the specified times, and I understand
                that repeated absences without a valid excuse may lead to
                administrative actions such as cancellation of reservation or
                rescheduling in addition to adhering to what is stated in the
                <a href="/en/terms-and-conditions/terms"
                  >terms and conditions</a
                >
                regarding attendance.
              </li>
              <li>
                <strong>Online Behavior:</strong><br />
                I pledge to monitor my son/daughter's behavior during online
                classes, and I realize that the academy has the right to take
                disciplinary actions in case of behavioral violations through
                the online platform.
              </li>
              <li>
                <strong>Technology and Responsibilities:</strong><br />
                I acknowledge that I am responsible for providing an electronic
                device and stable internet connection to ensure my
                son/daughter's participation in online classes, and I understand
                that the academy is not responsible for any technical issues
                related to the connection on my part.
              </li>
              <li>
                <strong>Withdrawal or Cancellation:</strong><br />
                I understand that if I wish to withdraw my son/daughter from the
                academy or cancel enrollment in the program, I must inform the
                administration in writing within a specified time frame, and I
                agree to adhere to the
                <a href="/en/terms-and-conditions/refund">cancellation</a> and
                refund policy as outlined in the
                <a href="/en/terms-and-conditions/terms"
                  >terms and conditions</a
                >
                specific to the academy's policies.
              </li>
              <li>
                <strong>Use of Educational Electronic Resources:</strong><br />
                I agree to the academy's use of e-learning platforms and modern
                technologies to deliver lessons, and I acknowledge that I have
                read and understood the
                <a href="/en/terms-and-conditions/privacy">privacy policy</a>
                related to the use of these resources.
              </li>
              <li>
                <strong>Photos and Videos:</strong><br />
                <ul>
                  <li>
                    Keeping the camera on throughout the lecture period to
                    ensure the quality of the educational process and facilitate
                    communication between teachers and trainees.
                  </li>
                  <li>
                    Ensuring to be in a quiet place away from noise with one of
                    the backgrounds specified by customer service.
                  </li>
                  <li>Using a computer screen at minimum or a laptop.</li>
                  <li>
                    Dressing appropriately (White - Blue - Black) to foster
                    discipline among the trainees.
                  </li>
                  <li>
                    All lectures are recorded and sent to all trainees for
                    general benefit. The recorded sessions are the exclusive
                    property of the academy, and it has the right to use them
                    for purposes such as "analyzing student levels or
                    promotional campaigns for the academy."
                  </li>
                </ul>
              </li>
              <li>
                <strong>Agreement to Terms:</strong><br />
                By clicking the purchase button, this constitutes your agreement
                to the terms and conditions stated above attached to Form No.
                MIA-TC-01.
              </li>
            </ol>
          </div>
        ...
        <button type="submit" class="checkout-button" :disabled="!isChecked">
          I agree and wish to continue to complete the order
        </button>
      </div>
    </div>
  </form>
